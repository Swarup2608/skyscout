...
export default function ItemImageCombo({
    ...
    return (
        <div className={`lg:px-[60px] py-[80px] space-y-2 flex px-[10] items-center justify-center ${isLeft ? 'flex-col-reverse lg:flex-row-reverse' : 'flex-col lg:flex-row'} gap-[50px] `}>
